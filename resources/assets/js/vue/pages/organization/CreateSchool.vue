<template>
    <div class="row">
        <div class="col-xl-6">
          ...
          <div class="form-group" :class="{ 'has-danger': $v.school.bankgiro_number.$invalid && shouldValidate, 'has-success': !$v.school.bankgiro_number.$invalid }">
          ...
          <div class="form-group" :class="{ 'has-danger': $v.school.organization_number.$invalid && shouldValidate, 'has-success': !$v.school.organization_number.$invalid }">
