                ...
                <transition appear v-on:enter="klarnaScroll">
                    <div id="klarna-process-scroller" class="klarna-process-inner">
                        ...
                        <div class="process-step step-kkj card card-block"
                            ...
                            <template v-if="!hasCompleted('NOT_INITIATED')">
                                <div class="klarna-card card card-block">
                                    <icon name="klarna-logo" class-name="logo-size mb-1"/>
                                ...
                                <div class="help">
                                    ...
                                    <div>Ring <a :href="`tel:${getPhones.customers.regular}`"
                                                 v-text="getPhones.customers.text"></a></div>
                                </div>
                            </template>
                        ...
                        <div class="process-step step-klarna card card-block"
                            ...
                            <h4 class="step-title mt-2">2. Klarna kontrollerar trafikskolans information</h4>
                        ...
                        <div class="process-step step-klarna card card-block"
                            ...
                            <icon name="klarna-logo" class-name="logo-size"/>
                            <h4 class="step-title mt-2">5. Kontrollfrågorna granskas av Klarna</h4>
...
<script type="text/babel">
    ...
    import CreateSchool from 'vue-pages/organization/CreateSchool';
        ...
        computed: {
            ...
            progress() {
                ...
                if (status == 'NOT_INITIATED') {
                    return 0;
                } else if (status == 'WAITING' || status == 'REJECTED') {
                    return 25;
                } else if (status == 'SUCCESS' || status == 'ACCESSED' || status == 'CANCELLED') {
                    return 50;
