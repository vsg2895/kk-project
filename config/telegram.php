...
return [
    ...
    */
    'commands' => [
        \Jakten\Modules\TelegramBot\Commands\CancelOrderCommand::class,
        Telegram\Bot\Commands\HelpCommand::class,
        \Jakten\Modules\TelegramBot\Commands\OrderManageCommand::class,
        \Jakten\Modules\TelegramBot\Commands\RunActivationCommand::class,
        \Jakten\Modules\TelegramBot\Commands\StartCommand::class,
    ],
];
