...
class UpdateViewForComparePrices extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        DB::statement('
            ...
            SELECT
                ...
                FLOOR(SUM(IF(vehicle_segments.comparable = 1, IF(vehicle_segments.name like \'DRIVING_LESSON%\', (school_segment_prices.amount/school_segment_prices.quantity)*IF(vehicle_segments.name = \'DRIVING_LESSON_CAR\', 600, 400), IF(school_segment_prices.amount, school_segment_prices.amount, vehicle_segments.default_price)), 0))) as comparison_price,
